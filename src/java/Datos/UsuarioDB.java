   ...
   public boolean delete(int idUser){
	...
	if(rta){
       ...
       public List getUsuarios() throws Exception{
            ...
            ResultSet resultado = EjecutarQuery("SELECT * FROM usuarios");
    ...
    {
        Usuario user = new Usuario();
        ResultSet resultado = EjecutarQuery("SELECT * FROM usuarios WHERE idUsuario = " + idUsuario);
	...
	{
		ResultSet resultado = EjecutarQuery("SELECT * FROM usuarios WHERE nombreUsuario = '" + usuario + "' AND pass = '" + pass + "'");
			Usuario user = null;
			while (resultado.next())
			{
				user = new Usuario();
