                            ...
                            <div id="tabla">
                                ...
                                for (int i = 0; i < proveedores.size(); i++) {
                                    if (i % 2 == 0)
                                    {
                                            %>
                                            <tr>
                                                <td><a href="<%= response.encodeURL("proveedor.jsp?id=" + proveedores.get(i).getIdProveedor())%>"><%= proveedores.get(i).getNombreProv()%></a></td>
                                                <td style="text-align:center"><%= proveedores.get(i).getApellidoProv()%></td>
